 ...
 * @bytes: bytes of memory neede per size requested
 ...
 * @c: input character to check fro digit
 ...
 * @num1: factor #1(smaller of the 2)
 * @len_1: length of factor 1
 * @num2: factor #2(larger of the 2)
 * @len_2: lenagth of factor 2
 * @len_r: length of result arrays
 * Return: 0 ail and 1 success
 */
